...
# ------------------- Set Specific Date ------------------- #
# target_date = '2025-07-07'  # <-- change this date as needed (format: YYYY-MM-DD)
# file_name = f"{target_date}_APR.xls"

source_dir = os.path.join(network_path, r"media\GOQII\APR_data")
target_dir = os.path.join(network_path, r"media\GOQII Clean\dialer_data")
...
# remote_dir = "/home/iccsadmin/APR_Data/GOQII/APR_Clean"
remote_dir = "/home/iccsadmin/ishita/APR_Uploads_V2/media/dialer_watch/GOQII"
