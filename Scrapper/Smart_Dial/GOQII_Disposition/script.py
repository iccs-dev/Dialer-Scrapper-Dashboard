"""GOQII_Disposition - Disposition Report scraper (Playwright).

Drives the shared flow in core/smart_dial_disposition.py.
Same dialer as the GOQII scraper.

    Media/GOQII/Disposition_data/<Y>/<M>/<D>/<date>.xlsx
    Media/GOQII/Clean_disposition/<Y>/<M>/<D>/<date>_Disposition.csv
