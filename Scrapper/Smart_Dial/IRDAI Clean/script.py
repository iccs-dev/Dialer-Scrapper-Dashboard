...
source_dir = os.path.join(network_path, r"media\IRDAI\APR_data")
target_dir = os.path.join(network_path, r"media\IRDAI Clean\dialer_data")
...
remote_dir = "/home/iccsadmin/ishita/APR_Uploads_V2/media/dialer_watch/IRDAI"
