"""Imagine Clean - clean the Imagine APR export.

Reads what the Imagine scraper left in Media/Imagine/APR_data/ and writes the
cleaned, headerless workbook to Media/Imagine/APR_Clean/<Y>/<M>/<D>/.
